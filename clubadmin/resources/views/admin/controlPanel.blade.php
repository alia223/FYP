                ...
                <div class="card-header" id="card-header">Control Panel</div>
                    ...
                    <form class="form-horizontal" method="POST"
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="number" name="booking_interval" id="booking_interval" url="booking_interval" value="<?php echo $rules->booking_interval; ?>"/>
                        </div>
                        <p class="font-weight-bold">Other Club Rules</p>
                            <div class="row">
                                <label class="col-md-3" for="booking_interval">Staff to Pupil Ratio: </label>
                                <div class="col-md-9">
